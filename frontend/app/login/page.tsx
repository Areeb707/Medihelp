...
export default function LoginPage() {
  ...
  const go = () => {
    ...
    // Clear any active patient from a previous doctor session
    localStorage.removeItem("medhelp_active_patient");
    localStorage.setItem("medhelp_doctor", JSON.stringify({ name:name.trim(), specialisation:role, initials }));
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom:24 }}>
          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8 }}>
            ...
            <div>
              <div style={{ fontSize:16, fontWeight:700, color:"white", letterSpacing:"-.3px" }}>Medhelp AI</div>
        ...
        <p style={{ fontSize:12, color:"#8a9ab8", lineHeight:1.6, maxWidth:420, marginBottom:18, borderLeft:"2px solid #00d4a030", paddingLeft:10 }}>
          Medhelp gives doctors a permanent AI memory for every patient built on Cognee Cloud's knowledge graph. Every diagnosis, every drug, every visit recalled in seconds.
        </p>
      ...
      <div style={{
        ...
        <div style={{ textAlign:"center", marginBottom:12, padding:"20px 16px", background:"#0c1120", border:"0.5px solid #1a2436", borderRadius:16 }}>
          ...
          <div style={{ fontSize:18, fontWeight:800, color:"white", letterSpacing:"-.4px", marginBottom:4 }}>Medhelp AI</div>
