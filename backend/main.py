...
# Settings.json (user-configured via Settings UI) takes priority over .env
...
if SETTINGS_PATH.exists():
    try:
        ...
        print("[Startup] Loaded API keys from settings.json (overrides .env)")
...
async def startup():
    ...
    print("\n" + "="*50)
    print("  Medhelp AI Backend starting...")
    print("="*50)
